 ...
 */
class LiteModelWrapper private constructor(model: ByteBuffer) : Closeable {
    ...
    companion object {
        private fun convertToDirectBuffer(data: ByteArray): ByteBuffer {
            val result = ByteBuffer.allocateDirect(data.size)
